...
PointParallelHashGridSearcher3::PointParallelHashGridSearcher3(
    ...
    double gridSpacing, bool debug) : PointParallelHashGridSearcher3(resolution.x, resolution.y, resolution.z, gridSpacing, debug)
{
}
...
PointParallelHashGridSearcher3::PointParallelHashGridSearcher3(
    ...
    size_t resolutionY,
    size_t resolutionZ,
    double gridSpacing, bool debug) : _gridSpacing(gridSpacing)
{
    _debug = debug;
    ...
    std::vector<uint8_t> *buffer) const
{
    ...
    {
        points.push_back(kiri_mathToFbs(pt));
    }
