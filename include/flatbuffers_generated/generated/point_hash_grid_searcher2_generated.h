...
#ifndef FLATBUFFERS_GENERATED_POINTHASHGRIDSEARCHER2_KIRI_MATH_FBS_H_
#define FLATBUFFERS_GENERATED_POINTHASHGRIDSEARCHER2_KIRI_MATH_FBS_H_
...
namespace kiri_math
{
  namespace fbs
  {
        ...
        const std::vector<uint64_t> *data = nullptr)
    {
      ...
      return kiri_math::fbs::CreatePointHashGridSearcherBucket2(
          _fbb,
          data__);
    }
    ...
    struct PointHashGridSearcher2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
    {
      ...
      const flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::PointHashGridSearcherBucket2>> *buckets() const
      {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::PointHashGridSearcherBucket2>> *>(VT_BUCKETS);
      }
      bool Verify(flatbuffers::Verifier &verifier) const
      {
        return VerifyTableStart(verifier) &&
    ...
    struct PointHashGridSearcher2Builder
    {
      ...
      void add_buckets(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::PointHashGridSearcherBucket2>>> buckets)
      {
    ...
    inline flatbuffers::Offset<PointHashGridSearcher2> CreatePointHashGridSearcher2(
        ...
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::PointHashGridSearcherBucket2>>> buckets = 0)
    {
    ...
    inline flatbuffers::Offset<PointHashGridSearcher2> CreatePointHashGridSearcher2Direct(
        ...
        const std::vector<flatbuffers::Offset<kiri_math::fbs::PointHashGridSearcherBucket2>> *buckets = nullptr)
    {
      auto points__ = points ? _fbb.CreateVectorOfStructs<kiri_math::fbs::Vector2D>(*points) : 0;
      auto buckets__ = buckets ? _fbb.CreateVector<flatbuffers::Offset<kiri_math::fbs::PointHashGridSearcherBucket2>>(*buckets) : 0;
      return kiri_math::fbs::CreatePointHashGridSearcher2(
          _fbb,
          gridSpacing,
          resolution,
          points__,
    ...
    inline const kiri_math::fbs::PointHashGridSearcher2 *GetPointHashGridSearcher2(const void *buf)
    {
      return flatbuffers::GetRoot<kiri_math::fbs::PointHashGridSearcher2>(buf);
    }

    inline const kiri_math::fbs::PointHashGridSearcher2 *GetSizePrefixedPointHashGridSearcher2(const void *buf)
    {
      return flatbuffers::GetSizePrefixedRoot<kiri_math::fbs::PointHashGridSearcher2>(buf);
    }

    inline bool VerifyPointHashGridSearcher2Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifyBuffer<kiri_math::fbs::PointHashGridSearcher2>(nullptr);
    }

    inline bool VerifySizePrefixedPointHashGridSearcher2Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifySizePrefixedBuffer<kiri_math::fbs::PointHashGridSearcher2>(nullptr);
    }

    inline void FinishPointHashGridSearcher2Buffer(
        flatbuffers::FlatBufferBuilder &fbb,
        flatbuffers::Offset<kiri_math::fbs::PointHashGridSearcher2> root)
    {
      fbb.Finish(root);
    }
...
#endif // FLATBUFFERS_GENERATED_POINTHASHGRIDSEARCHER2_KIRI_MATH_FBS_H_
