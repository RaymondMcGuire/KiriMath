...
#ifndef FLATBUFFERS_GENERATED_SPHSYSTEMDATA3_KIRI_MATH_FBS_H_
#define FLATBUFFERS_GENERATED_SPHSYSTEMDATA3_KIRI_MATH_FBS_H_
...
namespace kiri_math
{
  namespace fbs
  {
    ...
    struct SphSystemData3 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
    {
      ...
      const kiri_math::fbs::ParticleSystemData3 *base() const
      {
        return GetPointer<const kiri_math::fbs::ParticleSystemData3 *>(VT_BASE);
      }
    ...
    struct SphSystemData3Builder
    {
      ...
      void add_base(flatbuffers::Offset<kiri_math::fbs::ParticleSystemData3> base)
      {
    ...
    inline flatbuffers::Offset<SphSystemData3> CreateSphSystemData3(
        ...
        flatbuffers::Offset<kiri_math::fbs::ParticleSystemData3> base = 0,
    ...
    inline const kiri_math::fbs::SphSystemData3 *GetSphSystemData3(const void *buf)
    {
      return flatbuffers::GetRoot<kiri_math::fbs::SphSystemData3>(buf);
    }

    inline const kiri_math::fbs::SphSystemData3 *GetSizePrefixedSphSystemData3(const void *buf)
    {
      return flatbuffers::GetSizePrefixedRoot<kiri_math::fbs::SphSystemData3>(buf);
    }

    inline bool VerifySphSystemData3Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifyBuffer<kiri_math::fbs::SphSystemData3>(nullptr);
    }

    inline bool VerifySizePrefixedSphSystemData3Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifySizePrefixedBuffer<kiri_math::fbs::SphSystemData3>(nullptr);
    }

    inline void FinishSphSystemData3Buffer(
        flatbuffers::FlatBufferBuilder &fbb,
        flatbuffers::Offset<kiri_math::fbs::SphSystemData3> root)
    {
      fbb.Finish(root);
    }
...
#endif // FLATBUFFERS_GENERATED_SPHSYSTEMDATA3_KIRI_MATH_FBS_H_
