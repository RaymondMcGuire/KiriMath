...
#ifndef FLATBUFFERS_GENERATED_SPHSYSTEMDATA2_KIRI_MATH_FBS_H_
#define FLATBUFFERS_GENERATED_SPHSYSTEMDATA2_KIRI_MATH_FBS_H_
...
namespace kiri_math
{
  namespace fbs
  {
    ...
    struct SphSystemData2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
    {
      ...
      const kiri_math::fbs::ParticleSystemData2 *base() const
      {
        return GetPointer<const kiri_math::fbs::ParticleSystemData2 *>(VT_BASE);
      }
    ...
    struct SphSystemData2Builder
    {
      ...
      void add_base(flatbuffers::Offset<kiri_math::fbs::ParticleSystemData2> base)
      {
    ...
    inline flatbuffers::Offset<SphSystemData2> CreateSphSystemData2(
        ...
        flatbuffers::Offset<kiri_math::fbs::ParticleSystemData2> base = 0,
    ...
    inline const kiri_math::fbs::SphSystemData2 *GetSphSystemData2(const void *buf)
    {
      return flatbuffers::GetRoot<kiri_math::fbs::SphSystemData2>(buf);
    }

    inline const kiri_math::fbs::SphSystemData2 *GetSizePrefixedSphSystemData2(const void *buf)
    {
      return flatbuffers::GetSizePrefixedRoot<kiri_math::fbs::SphSystemData2>(buf);
    }

    inline bool VerifySphSystemData2Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifyBuffer<kiri_math::fbs::SphSystemData2>(nullptr);
    }

    inline bool VerifySizePrefixedSphSystemData2Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifySizePrefixedBuffer<kiri_math::fbs::SphSystemData2>(nullptr);
    }

    inline void FinishSphSystemData2Buffer(
        flatbuffers::FlatBufferBuilder &fbb,
        flatbuffers::Offset<kiri_math::fbs::SphSystemData2> root)
    {
      fbb.Finish(root);
    }
...
#endif // FLATBUFFERS_GENERATED_SPHSYSTEMDATA2_KIRI_MATH_FBS_H_
