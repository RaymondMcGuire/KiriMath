...
#ifndef FLATBUFFERS_GENERATED_SCALARGRID3_KIRI_MATH_FBS_H_
#define FLATBUFFERS_GENERATED_SCALARGRID3_KIRI_MATH_FBS_H_
...
namespace kiri_math
{
  namespace fbs
  {
        ...
        const std::vector<double> *data = nullptr)
    {
      ...
      return kiri_math::fbs::CreateScalarGrid3(
          _fbb,
          resolution,
          gridSpacing,
          origin,
    ...
    inline const kiri_math::fbs::ScalarGrid3 *GetScalarGrid3(const void *buf)
    {
      return flatbuffers::GetRoot<kiri_math::fbs::ScalarGrid3>(buf);
    }

    inline const kiri_math::fbs::ScalarGrid3 *GetSizePrefixedScalarGrid3(const void *buf)
    {
      return flatbuffers::GetSizePrefixedRoot<kiri_math::fbs::ScalarGrid3>(buf);
    }

    inline bool VerifyScalarGrid3Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifyBuffer<kiri_math::fbs::ScalarGrid3>(nullptr);
    }

    inline bool VerifySizePrefixedScalarGrid3Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifySizePrefixedBuffer<kiri_math::fbs::ScalarGrid3>(nullptr);
    }

    inline void FinishScalarGrid3Buffer(
        flatbuffers::FlatBufferBuilder &fbb,
        flatbuffers::Offset<kiri_math::fbs::ScalarGrid3> root)
    {
      fbb.Finish(root);
    }
...
#endif // FLATBUFFERS_GENERATED_SCALARGRID3_KIRI_MATH_FBS_H_
