...
#ifndef FLATBUFFERS_GENERATED_POINTPARALLELHASHGRIDSEARCHER3_KIRI_MATH_FBS_H_
#define FLATBUFFERS_GENERATED_POINTPARALLELHASHGRIDSEARCHER3_KIRI_MATH_FBS_H_
...
namespace kiri_math
{
  namespace fbs
  {
        ...
        const std::vector<uint64_t> *sortedIndices = nullptr)
    {
      ...
      return kiri_math::fbs::CreatePointParallelHashGridSearcher3(
          _fbb,
          gridSpacing,
          resolution,
          points__,
    ...
    inline const kiri_math::fbs::PointParallelHashGridSearcher3 *GetPointParallelHashGridSearcher3(const void *buf)
    {
      return flatbuffers::GetRoot<kiri_math::fbs::PointParallelHashGridSearcher3>(buf);
    }

    inline const kiri_math::fbs::PointParallelHashGridSearcher3 *GetSizePrefixedPointParallelHashGridSearcher3(const void *buf)
    {
      return flatbuffers::GetSizePrefixedRoot<kiri_math::fbs::PointParallelHashGridSearcher3>(buf);
    }

    inline bool VerifyPointParallelHashGridSearcher3Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifyBuffer<kiri_math::fbs::PointParallelHashGridSearcher3>(nullptr);
    }

    inline bool VerifySizePrefixedPointParallelHashGridSearcher3Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifySizePrefixedBuffer<kiri_math::fbs::PointParallelHashGridSearcher3>(nullptr);
    }

    inline void FinishPointParallelHashGridSearcher3Buffer(
        flatbuffers::FlatBufferBuilder &fbb,
        flatbuffers::Offset<kiri_math::fbs::PointParallelHashGridSearcher3> root)
    {
      fbb.Finish(root);
    }
...
#endif // FLATBUFFERS_GENERATED_POINTPARALLELHASHGRIDSEARCHER3_KIRI_MATH_FBS_H_
