...
#ifndef FLATBUFFERS_GENERATED_SCALARGRID2_KIRI_MATH_FBS_H_
#define FLATBUFFERS_GENERATED_SCALARGRID2_KIRI_MATH_FBS_H_
...
namespace kiri_math
{
  namespace fbs
  {
        ...
        const std::vector<double> *data = nullptr)
    {
      ...
      return kiri_math::fbs::CreateScalarGrid2(
          _fbb,
          resolution,
          gridSpacing,
          origin,
    ...
    inline const kiri_math::fbs::ScalarGrid2 *GetScalarGrid2(const void *buf)
    {
      return flatbuffers::GetRoot<kiri_math::fbs::ScalarGrid2>(buf);
    }

    inline const kiri_math::fbs::ScalarGrid2 *GetSizePrefixedScalarGrid2(const void *buf)
    {
      return flatbuffers::GetSizePrefixedRoot<kiri_math::fbs::ScalarGrid2>(buf);
    }

    inline bool VerifyScalarGrid2Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifyBuffer<kiri_math::fbs::ScalarGrid2>(nullptr);
    }

    inline bool VerifySizePrefixedScalarGrid2Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifySizePrefixedBuffer<kiri_math::fbs::ScalarGrid2>(nullptr);
    }

    inline void FinishScalarGrid2Buffer(
        flatbuffers::FlatBufferBuilder &fbb,
        flatbuffers::Offset<kiri_math::fbs::ScalarGrid2> root)
    {
      fbb.Finish(root);
    }
...
#endif // FLATBUFFERS_GENERATED_SCALARGRID2_KIRI_MATH_FBS_H_
