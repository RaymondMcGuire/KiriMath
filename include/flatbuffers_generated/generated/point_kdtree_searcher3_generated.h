...
#ifndef FLATBUFFERS_GENERATED_POINTKDTREESEARCHER3_KIRI_MATH_FBS_H_
#define FLATBUFFERS_GENERATED_POINTKDTREESEARCHER3_KIRI_MATH_FBS_H_
...
namespace kiri_math
{
  namespace fbs
  {
    ...
    public:
      ...
      {
        memset(static_cast<void *>(this), 0, sizeof(PointKdTreeSearcherNode3));
      }
    ...
    struct PointKdTreeSearcher3 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
    {
      ...
      const flatbuffers::Vector<const kiri_math::fbs::PointKdTreeSearcherNode3 *> *nodes() const
      {
        return GetPointer<const flatbuffers::Vector<const kiri_math::fbs::PointKdTreeSearcherNode3 *> *>(VT_NODES);
      }
    ...
    struct PointKdTreeSearcher3Builder
    {
      ...
      void add_nodes(flatbuffers::Offset<flatbuffers::Vector<const kiri_math::fbs::PointKdTreeSearcherNode3 *>> nodes)
      {
    ...
    inline flatbuffers::Offset<PointKdTreeSearcher3> CreatePointKdTreeSearcher3(
        ...
        flatbuffers::Offset<flatbuffers::Vector<const kiri_math::fbs::PointKdTreeSearcherNode3 *>> nodes = 0)
    {
    ...
    inline flatbuffers::Offset<PointKdTreeSearcher3> CreatePointKdTreeSearcher3Direct(
        ...
        const std::vector<kiri_math::fbs::PointKdTreeSearcherNode3> *nodes = nullptr)
    {
      auto points__ = points ? _fbb.CreateVectorOfStructs<kiri_math::fbs::Vector3D>(*points) : 0;
      auto nodes__ = nodes ? _fbb.CreateVectorOfStructs<kiri_math::fbs::PointKdTreeSearcherNode3>(*nodes) : 0;
      return kiri_math::fbs::CreatePointKdTreeSearcher3(
          _fbb,
          points__,
          nodes__);
    }

    inline const kiri_math::fbs::PointKdTreeSearcher3 *GetPointKdTreeSearcher3(const void *buf)
    {
      return flatbuffers::GetRoot<kiri_math::fbs::PointKdTreeSearcher3>(buf);
    }

    inline const kiri_math::fbs::PointKdTreeSearcher3 *GetSizePrefixedPointKdTreeSearcher3(const void *buf)
    {
      return flatbuffers::GetSizePrefixedRoot<kiri_math::fbs::PointKdTreeSearcher3>(buf);
    }

    inline bool VerifyPointKdTreeSearcher3Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifyBuffer<kiri_math::fbs::PointKdTreeSearcher3>(nullptr);
    }

    inline bool VerifySizePrefixedPointKdTreeSearcher3Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifySizePrefixedBuffer<kiri_math::fbs::PointKdTreeSearcher3>(nullptr);
    }

    inline void FinishPointKdTreeSearcher3Buffer(
        flatbuffers::FlatBufferBuilder &fbb,
        flatbuffers::Offset<kiri_math::fbs::PointKdTreeSearcher3> root)
    {
      fbb.Finish(root);
    }
...
#endif // FLATBUFFERS_GENERATED_POINTKDTREESEARCHER3_KIRI_MATH_FBS_H_
