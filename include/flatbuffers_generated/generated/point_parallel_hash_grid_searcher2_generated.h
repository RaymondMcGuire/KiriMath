...
#ifndef FLATBUFFERS_GENERATED_POINTPARALLELHASHGRIDSEARCHER2_KIRI_MATH_FBS_H_
#define FLATBUFFERS_GENERATED_POINTPARALLELHASHGRIDSEARCHER2_KIRI_MATH_FBS_H_
...
namespace kiri_math
{
  namespace fbs
  {
        ...
        const std::vector<uint64_t> *sortedIndices = nullptr)
    {
      ...
      return kiri_math::fbs::CreatePointParallelHashGridSearcher2(
          _fbb,
          gridSpacing,
          resolution,
          points__,
    ...
    inline const kiri_math::fbs::PointParallelHashGridSearcher2 *GetPointParallelHashGridSearcher2(const void *buf)
    {
      return flatbuffers::GetRoot<kiri_math::fbs::PointParallelHashGridSearcher2>(buf);
    }

    inline const kiri_math::fbs::PointParallelHashGridSearcher2 *GetSizePrefixedPointParallelHashGridSearcher2(const void *buf)
    {
      return flatbuffers::GetSizePrefixedRoot<kiri_math::fbs::PointParallelHashGridSearcher2>(buf);
    }

    inline bool VerifyPointParallelHashGridSearcher2Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifyBuffer<kiri_math::fbs::PointParallelHashGridSearcher2>(nullptr);
    }

    inline bool VerifySizePrefixedPointParallelHashGridSearcher2Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifySizePrefixedBuffer<kiri_math::fbs::PointParallelHashGridSearcher2>(nullptr);
    }

    inline void FinishPointParallelHashGridSearcher2Buffer(
        flatbuffers::FlatBufferBuilder &fbb,
        flatbuffers::Offset<kiri_math::fbs::PointParallelHashGridSearcher2> root)
    {
      fbb.Finish(root);
    }
...
#endif // FLATBUFFERS_GENERATED_POINTPARALLELHASHGRIDSEARCHER2_KIRI_MATH_FBS_H_
