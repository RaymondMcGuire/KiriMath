...
#ifndef FLATBUFFERS_GENERATED_GRIDSYSTEMDATA3_KIRI_MATH_FBS_H_
#define FLATBUFFERS_GENERATED_GRIDSYSTEMDATA3_KIRI_MATH_FBS_H_
...
namespace kiri_math
{
  namespace fbs
  {
        ...
        const std::vector<uint8_t> *data = nullptr)
    {
      ...
      return kiri_math::fbs::CreateScalarGridSerialized3(
          _fbb,
          type__,
          data__);
    }
        ...
        const std::vector<uint8_t> *data = nullptr)
    {
      auto type__ = type ? _fbb.CreateString(type) : 0;
      auto data__ = data ? _fbb.CreateVector<uint8_t>(*data) : 0;
      return kiri_math::fbs::CreateVectorGridSerialized3(
          _fbb,
          type__,
          data__);
    }
    ...
    struct GridSystemData3 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
    {
      ...
      const flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::ScalarGridSerialized3>> *scalarData() const
      {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::ScalarGridSerialized3>> *>(VT_SCALARDATA);
      }
      const flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::VectorGridSerialized3>> *vectorData() const
      {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::VectorGridSerialized3>> *>(VT_VECTORDATA);
      }
      const flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::ScalarGridSerialized3>> *advectableScalarData() const
      {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::ScalarGridSerialized3>> *>(VT_ADVECTABLESCALARDATA);
      }
      const flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::VectorGridSerialized3>> *advectableVectorData() const
      {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::VectorGridSerialized3>> *>(VT_ADVECTABLEVECTORDATA);
      }
      bool Verify(flatbuffers::Verifier &verifier) const
      {
        return VerifyTableStart(verifier) &&
    ...
    struct GridSystemData3Builder
    {
      ...
      void add_scalarData(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::ScalarGridSerialized3>>> scalarData)
      {
        fbb_.AddOffset(GridSystemData3::VT_SCALARDATA, scalarData);
      }
      void add_vectorData(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::VectorGridSerialized3>>> vectorData)
      {
        fbb_.AddOffset(GridSystemData3::VT_VECTORDATA, vectorData);
      }
      void add_advectableScalarData(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::ScalarGridSerialized3>>> advectableScalarData)
      {
        fbb_.AddOffset(GridSystemData3::VT_ADVECTABLESCALARDATA, advectableScalarData);
      }
      void add_advectableVectorData(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::VectorGridSerialized3>>> advectableVectorData)
      {
    ...
    inline flatbuffers::Offset<GridSystemData3> CreateGridSystemData3(
        ...
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::ScalarGridSerialized3>>> scalarData = 0,
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::VectorGridSerialized3>>> vectorData = 0,
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::ScalarGridSerialized3>>> advectableScalarData = 0,
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::VectorGridSerialized3>>> advectableVectorData = 0)
    {
    ...
    inline flatbuffers::Offset<GridSystemData3> CreateGridSystemData3Direct(
        ...
        const kiri_math::fbs::Vector3D *origin = 0,
        uint64_t velocityIdx = 0,
        const std::vector<flatbuffers::Offset<kiri_math::fbs::ScalarGridSerialized3>> *scalarData = nullptr,
        const std::vector<flatbuffers::Offset<kiri_math::fbs::VectorGridSerialized3>> *vectorData = nullptr,
        const std::vector<flatbuffers::Offset<kiri_math::fbs::ScalarGridSerialized3>> *advectableScalarData = nullptr,
        const std::vector<flatbuffers::Offset<kiri_math::fbs::VectorGridSerialized3>> *advectableVectorData = nullptr)
    {
      auto scalarData__ = scalarData ? _fbb.CreateVector<flatbuffers::Offset<kiri_math::fbs::ScalarGridSerialized3>>(*scalarData) : 0;
      auto vectorData__ = vectorData ? _fbb.CreateVector<flatbuffers::Offset<kiri_math::fbs::VectorGridSerialized3>>(*vectorData) : 0;
      auto advectableScalarData__ = advectableScalarData ? _fbb.CreateVector<flatbuffers::Offset<kiri_math::fbs::ScalarGridSerialized3>>(*advectableScalarData) : 0;
      auto advectableVectorData__ = advectableVectorData ? _fbb.CreateVector<flatbuffers::Offset<kiri_math::fbs::VectorGridSerialized3>>(*advectableVectorData) : 0;
      return kiri_math::fbs::CreateGridSystemData3(
          _fbb,
          resolution,
          gridSpacing,
          origin,
    ...
    inline const kiri_math::fbs::GridSystemData3 *GetGridSystemData3(const void *buf)
    {
      return flatbuffers::GetRoot<kiri_math::fbs::GridSystemData3>(buf);
    }

    inline const kiri_math::fbs::GridSystemData3 *GetSizePrefixedGridSystemData3(const void *buf)
    {
      return flatbuffers::GetSizePrefixedRoot<kiri_math::fbs::GridSystemData3>(buf);
    }

    inline bool VerifyGridSystemData3Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifyBuffer<kiri_math::fbs::GridSystemData3>(nullptr);
    }

    inline bool VerifySizePrefixedGridSystemData3Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifySizePrefixedBuffer<kiri_math::fbs::GridSystemData3>(nullptr);
    }

    inline void FinishGridSystemData3Buffer(
        flatbuffers::FlatBufferBuilder &fbb,
        flatbuffers::Offset<kiri_math::fbs::GridSystemData3> root)
    {
      fbb.Finish(root);
    }
...
#endif // FLATBUFFERS_GENERATED_GRIDSYSTEMDATA3_KIRI_MATH_FBS_H_
