...
#ifndef FLATBUFFERS_GENERATED_PARTICLESYSTEMDATA2_KIRI_MATH_FBS_H_
#define FLATBUFFERS_GENERATED_PARTICLESYSTEMDATA2_KIRI_MATH_FBS_H_
...
namespace kiri_math
{
  namespace fbs
  {
        ...
        const std::vector<double> *data = nullptr)
    {
      ...
      return kiri_math::fbs::CreateScalarParticleData2(
          _fbb,
          data__);
    }
    ...
    struct VectorParticleData2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
    {
      ...
      const flatbuffers::Vector<const kiri_math::fbs::Vector2D *> *data() const
      {
        return GetPointer<const flatbuffers::Vector<const kiri_math::fbs::Vector2D *> *>(VT_DATA);
      }
      bool Verify(flatbuffers::Verifier &verifier) const
      {
        return VerifyTableStart(verifier) &&
    ...
    struct VectorParticleData2Builder
    {
      flatbuffers::FlatBufferBuilder &fbb_;
      flatbuffers::uoffset_t start_;
      void add_data(flatbuffers::Offset<flatbuffers::Vector<const kiri_math::fbs::Vector2D *>> data)
      {
    ...
    inline flatbuffers::Offset<VectorParticleData2> CreateVectorParticleData2(
        flatbuffers::FlatBufferBuilder &_fbb,
        flatbuffers::Offset<flatbuffers::Vector<const kiri_math::fbs::Vector2D *>> data = 0)
    {
    ...
    inline flatbuffers::Offset<VectorParticleData2> CreateVectorParticleData2Direct(
        flatbuffers::FlatBufferBuilder &_fbb,
        const std::vector<kiri_math::fbs::Vector2D> *data = nullptr)
    {
      auto data__ = data ? _fbb.CreateVectorOfStructs<kiri_math::fbs::Vector2D>(*data) : 0;
      return kiri_math::fbs::CreateVectorParticleData2(
          _fbb,
          data__);
    }
        ...
        const std::vector<uint8_t> *data = nullptr)
    {
      ...
      return kiri_math::fbs::CreatePointNeighborSearcherSerialized2(
          _fbb,
          type__,
          data__);
    }
        ...
        const std::vector<uint64_t> *data = nullptr)
    {
      ...
      return kiri_math::fbs::CreateParticleNeighborList2(
          _fbb,
          data__);
    }
    ...
    struct ParticleSystemData2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
    {
      ...
      const flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::ScalarParticleData2>> *scalarDataList() const
      {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::ScalarParticleData2>> *>(VT_SCALARDATALIST);
      }
      const flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::VectorParticleData2>> *vectorDataList() const
      {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::VectorParticleData2>> *>(VT_VECTORDATALIST);
      }
      const kiri_math::fbs::PointNeighborSearcherSerialized2 *neighborSearcher() const
      {
        return GetPointer<const kiri_math::fbs::PointNeighborSearcherSerialized2 *>(VT_NEIGHBORSEARCHER);
      }
      const flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::ParticleNeighborList2>> *neighborLists() const
      {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::ParticleNeighborList2>> *>(VT_NEIGHBORLISTS);
      }
      bool Verify(flatbuffers::Verifier &verifier) const
      {
        return VerifyTableStart(verifier) &&
    ...
    struct ParticleSystemData2Builder
    {
      ...
      void add_scalarDataList(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::ScalarParticleData2>>> scalarDataList)
      {
        fbb_.AddOffset(ParticleSystemData2::VT_SCALARDATALIST, scalarDataList);
      }
      void add_vectorDataList(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::VectorParticleData2>>> vectorDataList)
      {
        fbb_.AddOffset(ParticleSystemData2::VT_VECTORDATALIST, vectorDataList);
      }
      void add_neighborSearcher(flatbuffers::Offset<kiri_math::fbs::PointNeighborSearcherSerialized2> neighborSearcher)
      {
        fbb_.AddOffset(ParticleSystemData2::VT_NEIGHBORSEARCHER, neighborSearcher);
      }
      void add_neighborLists(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::ParticleNeighborList2>>> neighborLists)
      {
    ...
    inline flatbuffers::Offset<ParticleSystemData2> CreateParticleSystemData2(
        ...
        uint64_t forceIdx = 0,
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::ScalarParticleData2>>> scalarDataList = 0,
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::VectorParticleData2>>> vectorDataList = 0,
        flatbuffers::Offset<kiri_math::fbs::PointNeighborSearcherSerialized2> neighborSearcher = 0,
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<kiri_math::fbs::ParticleNeighborList2>>> neighborLists = 0)
    {
    ...
    inline flatbuffers::Offset<ParticleSystemData2> CreateParticleSystemData2Direct(
        ...
        uint64_t velocityIdx = 0,
        uint64_t forceIdx = 0,
        const std::vector<flatbuffers::Offset<kiri_math::fbs::ScalarParticleData2>> *scalarDataList = nullptr,
        const std::vector<flatbuffers::Offset<kiri_math::fbs::VectorParticleData2>> *vectorDataList = nullptr,
        flatbuffers::Offset<kiri_math::fbs::PointNeighborSearcherSerialized2> neighborSearcher = 0,
        const std::vector<flatbuffers::Offset<kiri_math::fbs::ParticleNeighborList2>> *neighborLists = nullptr)
    {
      auto scalarDataList__ = scalarDataList ? _fbb.CreateVector<flatbuffers::Offset<kiri_math::fbs::ScalarParticleData2>>(*scalarDataList) : 0;
      auto vectorDataList__ = vectorDataList ? _fbb.CreateVector<flatbuffers::Offset<kiri_math::fbs::VectorParticleData2>>(*vectorDataList) : 0;
      auto neighborLists__ = neighborLists ? _fbb.CreateVector<flatbuffers::Offset<kiri_math::fbs::ParticleNeighborList2>>(*neighborLists) : 0;
      return kiri_math::fbs::CreateParticleSystemData2(
          _fbb,
          radius,
          mass,
          positionIdx,
    ...
    inline const kiri_math::fbs::ParticleSystemData2 *GetParticleSystemData2(const void *buf)
    {
      return flatbuffers::GetRoot<kiri_math::fbs::ParticleSystemData2>(buf);
    }

    inline const kiri_math::fbs::ParticleSystemData2 *GetSizePrefixedParticleSystemData2(const void *buf)
    {
      return flatbuffers::GetSizePrefixedRoot<kiri_math::fbs::ParticleSystemData2>(buf);
    }

    inline bool VerifyParticleSystemData2Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifyBuffer<kiri_math::fbs::ParticleSystemData2>(nullptr);
    }

    inline bool VerifySizePrefixedParticleSystemData2Buffer(
        flatbuffers::Verifier &verifier)
    {
      return verifier.VerifySizePrefixedBuffer<kiri_math::fbs::ParticleSystemData2>(nullptr);
    }

    inline void FinishParticleSystemData2Buffer(
        flatbuffers::FlatBufferBuilder &fbb,
        flatbuffers::Offset<kiri_math::fbs::ParticleSystemData2> root)
    {
      fbb.Finish(root);
    }
...
#endif // FLATBUFFERS_GENERATED_PARTICLESYSTEMDATA2_KIRI_MATH_FBS_H_
