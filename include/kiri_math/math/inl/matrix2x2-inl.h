...
namespace kiri_math
{
        ...
        const std::initializer_list<std::initializer_list<U>> &lst)
    {
        ...
        BBR_MATH_ASSERT(width == 2);
        BBR_MATH_ASSERT(height == 2);
    ...
    {
        return ::kiri_math::absmin(::kiri_math::absmin(_elements[0], _elements[1]),
                                   ::kiri_math::absmin(_elements[2], _elements[3]));
    }

    template <typename T>
    T Matrix<T, 2, 2>::absmax() const
    {
        return ::kiri_math::absmax(::kiri_math::absmax(_elements[0], _elements[1]),
                                   ::kiri_math::absmax(_elements[2], _elements[3]));
    }
