...
#ifndef _KIRI_MATH_VERTEX_CENTERED_SCALAR_GRID3_H_
#define _KIRI_MATH_VERTEX_CENTERED_SCALAR_GRID3_H_
...
namespace kiri_math
{
    ...
    {
    public:
        KIRI_GRID3_TYPE_NAME(VertexCenteredScalarGrid3)
...
#endif // _KIRI_MATH_VERTEX_CENTERED_SCALAR_GRID3_H_
