...
#ifndef _KIRI_MATH_CELL_CENTERED_SCALAR_GRID3_H_
#define _KIRI_MATH_CELL_CENTERED_SCALAR_GRID3_H_
...
namespace kiri_math
{
    ...
    {
    public:
        KIRI_GRID3_TYPE_NAME(CellCenteredScalarGrid3)
...
#endif // _KIRI_MATH_CELL_CENTERED_SCALAR_GRID3_H_
