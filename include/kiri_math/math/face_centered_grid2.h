#ifndef _KIRI_MATH_FACE_CENTERED_GRID2_H_
#define _KIRI_MATH_FACE_CENTERED_GRID2_H_
...
namespace kiri_math
{
    ...
    {
    public:
        KIRI_GRID2_TYPE_NAME(FaceCenteredGrid2)
...
#endif // _KIRI_MATH_FACE_CENTERED_GRID2_H_
