 ...
 * @Last Modified time: 2019-12-14 02:27:02 
 */
#ifndef _KIRI_MATH_PARTICLE_SYSTEM_SOLVER3_H_
#define _KIRI_MATH_PARTICLE_SYSTEM_SOLVER3_H_
...
namespace kiri_math
{
    ...
    protected:
        ...
        //! Update the life cycle of the particles
    ...
    private:
        ...
        ParticleSystemData3::VectorData _newForces;
        ParticleSystemData3::ScalarData _newLifeTimes;
    ...
    public:
        ...
        //! Returns builder with life cycle
        DerivedBuilder &withLifeCycle(bool lifeCycle);

        //! Returns builder with max life cycle
        DerivedBuilder &withMaxLifeCycle(double maxLifeCycle);
    ...
    template <typename T>
    T &ParticleSystemSolverBuilderBase3<T>::withLifeCycle(bool lifeCycle)
    {
    ...
    template <typename T>
    T &ParticleSystemSolverBuilderBase3<T>::withMaxLifeCycle(double maxLifeCycle)
    {
        _maxLifeCycle = maxLifeCycle;
        return static_cast<T &>(*this);
    }
...
#endif // _KIRI_MATH_PARTICLE_SYSTEM_SOLVER3_H_
