 ...
 * @Last Modified time: 2019-12-14 02:27:08 
 */
/*
 * @Author: Doyub Kim 
 * @Last Modified by: Xu.Wang
 * @Last Modified time: 2019-12-14 02:27:06
 */
#ifndef _KIRI_MATH_PARTICLE_SYSTEM_DATA3_H_
#define _KIRI_MATH_PARTICLE_SYSTEM_DATA3_H_
...
namespace kiri_math
{
    ...
    public:
        ...
        //! Returns the boolean of the life cycle
        bool lifeCycle() const;

        //! Sets the boolean of the life cycle
        virtual void setLifeCycle(bool newLifeCycle);

        //! Returns the maximum of the life cycle
        double maxLifeCycle() const;

        //! Sets the maximum of the life cycle
        virtual void setMaxLifeCycle(double newMaxLifeCycle);
        ...
        //! Returns the life cycle time array (immutable).
        ConstArrayAccessor1<double> lifeTimes() const;

        //! Returns the life cycle time array (mutable).
        ArrayAccessor1<double> lifeTimes();
        ...
        void addParticles(
            ...
            const ConstArrayAccessor1<double> &newLifeTimes = ConstArrayAccessor1<double>());
...
#endif // _KIRI_MATH_PARTICLE_SYSTEM_DATA3_H_
