/*
 * @Author: Doyub Kim 
 * @Date: 2020-04-19 00:48:04 
 * @Last Modified by: Xu.Wang
 * @Last Modified time: 2020-04-19 00:48:43
 */
#ifndef _KIRI_MATH_POINT_PARALLEL_HASH_GRID_SEARCHER3_H_
#define _KIRI_MATH_POINT_PARALLEL_HASH_GRID_SEARCHER3_H_
...
namespace kiri_math
{
    ...
    {
    public:
        KIRI_NEIGHBOR_SEARCHER3_TYPE_NAME(PointParallelHashGridSearcher3)
        ...
        PointParallelHashGridSearcher3(
            const Size3 &resolution, double gridSpacing, bool debug = false);
        ...
        PointParallelHashGridSearcher3(
            ...
            size_t resolutionY,
            size_t resolutionZ,
            double gridSpacing, bool debug = false);
...
#endif // _KIRI_MATH_POINT_PARALLEL_HASH_GRID_SEARCHER3_H_
