#ifndef _KIRI_MATH_POINT_HASH_GRID_SEARCHER2_H_
#define _KIRI_MATH_POINT_HASH_GRID_SEARCHER2_H_
...
namespace kiri_math
{
    ...
    {
    public:
        KIRI_NEIGHBOR_SEARCHER2_TYPE_NAME(PointHashGridSearcher2)
...
#endif // _KIRI_MATH_POINT_HASH_GRID_SEARCHER2_H_
